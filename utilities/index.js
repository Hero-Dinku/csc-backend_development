...
Util.buildDetailView = async function(vehicle) {
  let detailView = '<div id="vehicle-detail">'
  detailView += '<div class="vehicle-image">'
  detailView += '<img src="' + vehicle.inv_image + '" alt="' + vehicle.inv_make + ' ' + vehicle.inv_model + '">'
  detailView += '</div>'
  detailView += '<div class="vehicle-info">'
  detailView += '<h2>' + vehicle.inv_year + ' ' + vehicle.inv_make + ' ' + vehicle.inv_model + '</h2>'
  detailView += '<p class="price"><strong>Price: $' + new Intl.NumberFormat('en-US').format(vehicle.inv_price) + '</strong></p>'
